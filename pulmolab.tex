...
With the advent of modern medical imaging and the rapid increase in computing power, it is now possible to derive models that replicate the many geometric features of individual lungs, and to simulate function within these geometric models, taking into account their different spatial and time scales \citep{Tawhai2010, Tawhai2000, Tawhai2008, Tahwai2000, Burrowes2005}.
