...
I also envision collaborations with the academic and industrial partners of the European Project THROMBUS, whose aim is to evaluate the efficacy of the use of stents in neurological aneurysms, and researchers involved with the state of the art in gas exchange modelling and simulations. Likewise, I would to be in close contact with the research groups involved in the Lung Physiome project, possibly the leading researchers in the field. All these groups combine expertise in different areas and will certainly be a good source of information for this project.
...
I will be the coordinator and main researcher in this project and therefore the direct benefiter of offered grant. However, I recognize the proposed project is rather ambitious and I will not be able to work on it alone. Some of the challenges described above may solved in the context of Master thesis or even PhD thesis, funding for which will be requested from the usual Brazilian funding bodies. Yet, I am convinced that it will be necessary to hire an extra research engineer for the entire duration of the project (three years), who will mostly take care of implementing the algorithms devised to solve the challenges and those from the literature that may be useful. Consequently, part of the extra research funding (R\$ 20.000,00/year) will be used to purchase equipment for myself and for the hired engineer. Occasionally, part of this funding may also be used for trips to collect data, in case they cannot be transfered electronically.
